...
// NOTIFIER + STATE
import 'package:teki_app/src/providers/tickets_sale/helpers/tickets_sale_notifier.dart';
import 'package:teki_app/src/providers/tickets_sale/tickets_sale_state.dart';
import 'package:teki_app/src/utils/notifications.dart';

final ticketSaleProvider =
    StateNotifierProvider<TicketSaleNotifier, TicketSaleState>((ref) {
  final TicketsSaleRepository ticketRepository = TicketSaleRepositoryImpl();
  return TicketSaleNotifier(ticketsSaleRepository: ticketRepository);
});
