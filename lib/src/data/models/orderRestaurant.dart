...
import 'package:teki_app/src/data/models/check.dart';
import 'package:teki_app/src/data/models/command.dart';
import 'package:teki_app/src/data/models/company.dart';
import 'package:teki_app/src/data/models/cutomer.dart';
import 'package:teki_app/src/data/models/delivery.dart';
import 'package:teki_app/src/data/models/office.dart';
import 'package:teki_app/src/data/models/table.dart';
...
class OrderRestaurant {
  ...
  factory OrderRestaurant.fromJson(Map<String, dynamic> json) => OrderRestaurant(
    ...
    fechaAceptacion: json['fechaAceptacion'] != null ? DateTime.parse(json['fechaAceptacion']) : null,
