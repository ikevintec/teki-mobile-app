...
copyWith({
    ...
    return Ticket(
      ...
      codigoLocalAnexoEmisor: codigoLocalAnexoEmisor ?? this.codigoLocalAnexoEmisor,
      tipoDocumentoReceptor: tipoDocumentoReceptor ?? this.tipoDocumentoReceptor,
      numeroDocumentoReceptor: numeroDocumentoReceptor ?? this.numeroDocumentoReceptor,
      ...
      numeroOrdenRestaurante: numeroOrdenRestaurante ?? this.numeroOrdenRestaurante,
      codigoTipoOtroDocumentoRelacionado:
          codigoTipoOtroDocumentoRelacionado ?? this.codigoTipoOtroDocumentoRelacionado,
      serieNumeroOtroDocumentoRelacionado:
          serieNumeroOtroDocumentoRelacionado ?? this.serieNumeroOtroDocumentoRelacionado,
      totalValorVentaExportacion:
          totalValorVentaExportacion ?? this.totalValorVentaExportacion,
      totalValorVentaGravada: totalValorVentaGravada ?? this.totalValorVentaGravada,
      ...
      porcentajeOtrosCargos: porcentajeOtrosCargos ?? this.porcentajeOtrosCargos,
      ...
      porcentajeDescuentoGlobal: porcentajeDescuentoGlobal ?? this.porcentajeDescuentoGlobal,
      serieAfectado: serieAfectado ?? this.serieAfectado,
      numeroAfectado: numeroAfectado ?? this.numeroAfectado,
      tipoComprobanteAfectado: tipoComprobanteAfectado ?? this.tipoComprobanteAfectado,
      motivoNota: motivoNota ?? this.motivoNota,
      codigoTipoNotaCredito: codigoTipoNotaCredito ?? this.codigoTipoNotaCredito,
      codigoTipoNotaDebito: codigoTipoNotaDebito ?? this.codigoTipoNotaDebito,
      identificadorDocumento: identificadorDocumento ?? this.identificadorDocumento,
      ...
      codigosRespuestaSunat: codigosRespuestaSunat ?? this.codigosRespuestaSunat,
      boletaAnuladaSinEmitir: boletaAnuladaSinEmitir ?? this.boletaAnuladaSinEmitir,
