...
class Category {
  ...
  final ProductionArea? areaProduccionSecundaria;
  ...
  factory Category.fromJson(Map<String, dynamic> json) => Category(
    ...
    areaProduccion: json['areaProduccion'] != null
        ...
        : null,
    areaProduccionSecundaria: json['areaProduccionSecundaria'] != null
        ? ProductionArea.fromJson(json['areaProduccionSecundaria'])
        : null,
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    'areaProduccionSecundaria': areaProduccionSecundaria?.toJson(),
  };
}
